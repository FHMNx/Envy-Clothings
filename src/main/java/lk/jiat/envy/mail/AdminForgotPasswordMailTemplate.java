...
public class AdminForgotPasswordMailTemplate extends Mailable{

    private final String to;
    private final String resetToken;

    public AdminForgotPasswordMailTemplate(String to, String resetToken) {
        this.to = to;
    ...
    public void build(Message message) throws MessagingException {
        ...
        message.setSubject("Reset your Admin password - " + Env.get("app.name"));

        String resetUrl = Env.get("app.url") + "/admin-resetPassword.html?email=" + to + "&token=" + resetToken;
        ...
        HtmlTextEmail email = getEmailTemplateBuilder()
                ...
                .text("Admin Password Reset Request").h1().center().and().hr().and()
